...
class SocketNamespacePacketTest: XCTestCase {
    ...
    func testEmpyEmit() {
        ...
        let packet = SocketPacketV1.packetFromEmit(sendData, id: -1, nsp: "/swift", ack: false)
    ...
    func testEmitWithAck() {
        ...
        let sendData = ["test"]
        let packet = SocketPacketV1.packetFromEmit(sendData, id: 0, nsp: "/swift", ack: false)
    ...
    func testEmptyAck() {
        ...
        let packet = SocketPacketV1.packetFromEmit([], id: 0, nsp: "/swift", ack: true)
    ...
    func testNullAck() {
        ...
        let sendData = [NSNull()]
        let packet = SocketPacketV1.packetFromEmit(sendData, id: 0, nsp: "/swift", ack: true)
    ...
    func testMultipleBinaryAck() {
        ...
        let packet = SocketPacketV1.packetFromEmit(sendData, id: 0, nsp: "/", ack: true)
